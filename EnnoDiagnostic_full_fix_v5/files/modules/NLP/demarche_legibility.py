...
VERSION = "demarche_legibility_v4_project_evidence_only_causal_chain"
...
_REFERENCE_BODY_RE = re.compile(
    ...
    r"l etude a (?:inclus|porte)|analyse de \d+ (?:papers?|articles?|publications?)|survey|systematic review|"
    r"certaines etudes (?:montrent|suggerent|indiquent)|des etudes (?:montrent|suggerent|indiquent)|et al\.)\b",
    re.I,
)
