...
VERSION = "historical_continuity_reconciler_v400_active_memory_composite_recovery"
...
def _gap_probe(
    ...
    max_role_queries = max(1, int(os.getenv("ENNOSMART_HISTORICAL_GAP_ROLE_QUERIES", "5")))
    role_count = 0
    ...
    per_query_top_k = max(4, min(top_k, int(os.getenv("ENNOSMART_HISTORICAL_GAP_PER_QUERY_TOP_K", "7"))))
...
def reconcile_historical_continuity(
    *,
    ...
    max_gap_families = max(0, int(os.getenv("ENNOSMART_HISTORICAL_GAP_MAX_FAMILIES", "20")))
