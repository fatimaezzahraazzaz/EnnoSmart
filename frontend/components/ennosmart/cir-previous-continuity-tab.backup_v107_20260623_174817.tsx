...
export default function CirPreviousContinuityTab({
  ...
  const hasPreviousCir =
    memory.has_previous_cir === true ||
    memory.previous_cir_items_count > 0 ||
    totalCount > 0
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Ajoutez d’abord un CIR final validé sur l’année précédente pour afficher les passages communs et les preuves de continuité.
          </p>
        </CardContent>
      </Card>
    )
