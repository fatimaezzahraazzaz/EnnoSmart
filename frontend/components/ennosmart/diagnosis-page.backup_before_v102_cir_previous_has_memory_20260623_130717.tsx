              ...
              {previousCirUploadReport && (
                <div className="rounded-lg border bg-success/5 border-success/20 p-4 space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {previousCirUploadReport.items_count || 0} passages ont été ajoutés à la mémoire CIR. Tu peux lancer la comparaison avec le CIR précédent sans réimporter le fichier.
                  </p>
                </div>
              )}
            </CardContent>
            ...
            <CardContent className="flex flex-wrap items-center gap-2">
              ...
              {previousCirList.length > 0 ? (
                <p className="text-xs text-blue-800">
                  ...
                  {previousCirList
                    .map((item: any) => `${item.year} · ${item.items_count || 0} passages mémoire`)
                    .join(", ")}
                </p>
              ) : previousCirUploadReport ? (
                <p className="text-xs text-blue-800">
                  CIR final {previousCirUploadReport.previous_cir_year} enregistré : tu peux lancer la comparaison.
                </p>
              ) : (
                <p className="text-xs text-muted-foreground">
