...
def _diag_enrich_sections_for_real_agent(agent: "EnnoDiagnosticAgent", sections: Dict[str, List[Dict[str, Any]]]) -> Dict[str, List[Dict[str, Any]]]:
    ...
    sections["_agent_selection_report"] = {
        "version": "v132_objective_nlp_authority_lock_path_unchanged",
        "principle": (
...
class EnnoDiagnosticAgent:
    ...
    def retrieve_all_sections(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        if current_project_only and fast_nlp_authority:
            ...
            if has_current_nlp:
                ...
                # Important : aucune nouvelle logique de regroupement de verrou.
                # On transmet exactement les groupes NLP courants + les candidats
                # de récupération stricte déjà utilisés en V5.2/V5.3.
                ...
                sections["_retrieval_report"] = {
                    ...
                    "lock_policy": "unchanged_nlp_groups_plus_strict_recovery",
                }
                print(
    ...
    def load_cir_memory_report(
        ...
        trust_local_preflight = str(
            os.getenv("ENNOSMART_DIAG_TRUST_LOCAL_YEAR_PREFLIGHT", "1")
        ).strip().lower() not in {"0", "false", "no", "off"}
...
""".strip()
    ...
    def generate_diagnostic(self, save: bool = True) -> Dict[str, Any]:
        ...
        report: Dict[str, Any] = {
            "ok": True,
            "status": "completed",
            "version": "ennodiagnostic_v328_guard_fix_fast_frascati_v55",
