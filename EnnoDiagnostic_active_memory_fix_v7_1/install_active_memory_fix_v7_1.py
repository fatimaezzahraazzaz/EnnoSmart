...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Installe EnnoDiagnostic Active Memory V7.1."
    )
    ...
    backup_root = repo.parent / "EnnoSmart_patch_backups" / f"active_memory_v7_1_{stamp}"

    print("[INFO] V7.1 remplace uniquement 4 fichiers EnnoDiagnostic.")
    ...
    print("")
    print("[OK] Installation V7.1 terminée.")
    print("[INFO] Frascati, scores, NLP, chat/RAG, frontend et evidence_graph ne sont pas remplacés.")
