# EnnoDiagnostic — Role Restore V3.1
...
```powershell
cd C:\EnnoSmart
python "C:\EnnoSmart\EnnoDiagnostic_role_restore_v3_1\apply_patch_v3_1.py" --repo "C:\EnnoSmart"
```

Puis vérifier :

```powershell
python "C:\EnnoSmart\EnnoDiagnostic_role_restore_v3_1\verify_patch_v3_1.py" --repo "C:\EnnoSmart"
```

Le script crée automatiquement une sauvegarde sous `.ennosmart_patch_backups\role_restore_v3_1_...` et restaure cette sauvegarde si l'application ou la compilation échoue.
...
```powershell
python "C:\EnnoSmart\EnnoDiagnostic_role_restore_v3_1\apply_patch_v3_1.py" --repo "C:\EnnoSmart" --rollback
```
