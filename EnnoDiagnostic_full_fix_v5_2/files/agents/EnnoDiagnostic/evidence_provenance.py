...
_THIRD_PARTY_ATTRIBUTION_RE = re.compile(
    ...
    r"une [eé]tude empirique|ils ont (?:utilis[eé]|cr[eé][eé]|entra[iî]n[eé]|propos[eé]|compar[eé]|[eé]valu[eé])|"
    r"une approche .{0,120}(?:a [eé]t[eé]|est) propos[eé]e|"
    r"les r[eé]sultats montrent que .{0,220}(?:couramment|fr[eé]quemment)|"
