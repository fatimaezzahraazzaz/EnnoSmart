...
def map_section_type(title: str, parent_type: Optional[str] = None) -> str:
    ...
    if any(k in t for k in ['etat de l art', 'state of the art', 'connaissances existantes',  "analyse des connaissances",'bibliograph', 'solutions existantes',"caracterisation et reduction",
        "caracterisation",]):
        return 'etat_art'
