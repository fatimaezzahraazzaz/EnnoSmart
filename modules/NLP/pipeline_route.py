    ...
    **_: Any,
    ...
    result = {
        ...
        "stats": {
            ...
            "rnd_defensibility_index": (frascati.get("frascati_assessment") or {}).get("rnd_defensibility_index", 0.0),
            "demarche_operations": demarche_legibility.get("operations_count", 0),
            "demarche_rnd_core_defendable_operations": demarche_legibility.get("rnd_core_defendable_operations_count", 0),
            "demarche_rnd_core_partial_operations": demarche_legibility.get("rnd_core_partial_operations_count", 0),
            "demarche_classical_engineering_operations": demarche_legibility.get("classical_engineering_operations_count", 0),
            "demarche_insufficient_evidence_operations": demarche_legibility.get("insufficient_evidence_operations_count", 0),
            "demarche_activities": demarche_legibility.get("activities_count", 0),
            "demarche_direct_rnd_activities": demarche_legibility.get("direct_rnd_activities_count", 0),
            "demarche_necessary_rnd_support_activities": demarche_legibility.get("necessary_rnd_support_activities_count", 0),
            "demarche_classical_engineering_activities": demarche_legibility.get("classical_engineering_activities_count", 0),
            "demarche_insufficient_evidence_activities": demarche_legibility.get("insufficient_evidence_activities_count", 0),
