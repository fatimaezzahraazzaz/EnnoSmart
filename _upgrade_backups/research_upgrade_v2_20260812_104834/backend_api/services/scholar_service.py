...
def run_ennoscholar_from_selected_verrous(
    ...
    # >>> ENNOSMART_RESEARCH_UPGRADE_V1_PREFLIGHT
    try:
        from services.scholar_evidence_preflight_service import preflight_scholar_run
        preflight_report = preflight_scholar_run(db, project, run)
        raw = dict(run.raw_result_json or {})
        raw["evidence_preflight"] = preflight_report
