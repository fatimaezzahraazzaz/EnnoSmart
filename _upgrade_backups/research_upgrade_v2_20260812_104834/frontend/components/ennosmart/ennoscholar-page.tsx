...
function getEvidencePreflight(article: ArticleRead) {
  ...
  return sj?.evidence_preflight || null
}
...
function evidenceShortLabel(status?: string) {
  switch (status) {
    ...
    case "ABSTRACT_READY": return "Abstract uniquement"
    case "METADATA_ONLY": return "Texte intégral indisponible"
    case "EXTRACTION_FAILED": return "Extraction à vérifier"
    default: return "Accès non vérifié"
  }
}
